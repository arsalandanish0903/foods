    ...
    return (
        <>
            <div className='relative h-screen w-full overflow-hidden'>
                <div className='bg-[url("https://foods-images.netlify.app/images/bg-hero.jpg")] bg-cover bg-center h-full w-full absolute top-0'>
                    ...
                    <div className='p-8 md:p-16 relative w-full flex flex-col md:flex-row md:items-center h-full'>
                        ...
                        <div className='md:w-1/2 flex justify-center md:p-11'>
                            <img
                                ...
                                src="https://foods-images.netlify.app/images/hero.png"
                                alt="Hero Image"
                            />
                        </div>
                    </div>
