...
function Image() {
    const images = [
        { src: './public/about1.jpg', alt: 'About Image 1' },
        { src: './public/about2.jpg', alt: 'About Image 1' },
        { src: './public/about3.jpg', alt: 'About Image 1' },
        { src: './public/about4.jpg', alt: 'About Image 1' }
    ]
    return (
        <>
